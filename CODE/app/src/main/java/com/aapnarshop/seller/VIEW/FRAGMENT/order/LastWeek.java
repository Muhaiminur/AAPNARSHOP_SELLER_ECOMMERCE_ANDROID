...
import com.aapnarshop.seller.databinding.FragmentLastweekBinding;
...
public class LastWeek extends Fragment {
  ...
  FragmentLastweekBinding binding;
  OrderViewModel orderViewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_lastweek, container, false);
        orderViewModel = new ViewModelProvider(this).get(OrderViewModel.class);
        utility = new Utility(getActivity());
        observeOrderList();
        binding.lastWeekSwipeRefresh.setOnRefreshListener(this::observeOrderList);
        return binding.getRoot();
    }

    private void observeOrderList() {

        OrderListRequest orderListRequest = new OrderListRequest(KeyWord.TYPE_ALL, KeyWord.KEYWORD_WEEK, "", "");
