...
import com.aapnarshop.seller.databinding.FragmentLastYearBinding;
...
public class LastYear extends Fragment {

    FragmentLastYearBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_last_year, container, false);
        orderViewModel = new ViewModelProvider(this).get(OrderViewModel.class);
        utility = new Utility(getActivity());
        binding.lastYearSwipeRefresh.setRefreshing(true);
        observeOrderList();
        binding.lastYearSwipeRefresh.setOnRefreshListener(this::observeOrderList);
        return binding.getRoot();
    }

    private void observeOrderList() {

        OrderListRequest orderListRequest = new OrderListRequest(KeyWord.TYPE_ALL, KeyWord.KEYWORD_YEAR, "", "");
